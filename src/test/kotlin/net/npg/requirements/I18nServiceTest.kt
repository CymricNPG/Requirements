...
class I18nServiceTest {
    ...
    fun `test singleton pattern`() {
        val service1 = ClassPathI18nService.getInstance()
        val service2 = ClassPathI18nService.getInstance()
    ...
    fun `test get message english`() {
        ...
        val i18nService = ClassPathI18nService.getInstance()

        // Test mit existierendem Schlüssel
        val message = i18nService.getString("requirement.create.title")
        assertEquals("Create New Requirement", message)

        // Test mit nicht existierendem Schlüssel
        val nonExistent = i18nService.getString("non.existent.key")
    ...
    fun `test get message with parameters`() {
        ...
        // Test mit Parametern
        val message = i18nService.getString("requirement.create.title", "Test")
        assertEquals("Create New Requirement", message)
    ...
    fun `test get message with parameters in german`() {
        ...
        // Test mit Parametern
        val germanMessage = i18nService.getString("requirement.create.title", "Test")
